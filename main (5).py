...
cannot be acessed diresctly from outside the class. Write a program to create an instance of the
BankAccount class and test the deposit and withdrawl functionally.'''


class BankAccount:

  def __intit__(self, account_number, account_holder_name,initial_balance=0.0):
